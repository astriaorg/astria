...
mod optimistic_execution_proxy;
mod rollup_channel;
...
/// The [`OptimisticExecutionPRoxy`] service returned by [`OptimisticExecutionPRoxy::spawn`].
pub struct OptimisticExecutionProxy {
...
impl OptimisticExecutionProxy {
    ...
    pub fn spawn(cfg: Config, _metrics: &'static Metrics) -> eyre::Result<Self> {
        ...
        let inner = optimistic_execution_proxy::OptimisticExecutionProxy::new(
            cfg,
...
impl Future for OptimisticExecutionProxy {
