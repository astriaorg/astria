...
pub mod astria_mintable_erc20 {
    ...
    pub static ASTRIAMINTABLEERC20_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    ...
    pub static ASTRIAMINTABLEERC20_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static ASTRIAMINTABLEERC20_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    ...
    impl ::ethers::contract::EthLogDecode for AstriaMintableERC20Events {
        fn decode_log(
            ...
            if let Ok(decoded) = SequencerWithdrawalFilter::decode_log(log) {
                return Ok(AstriaMintableERC20Events::SequencerWithdrawalFilter(decoded));
            }
    ...
    ///Container type for all input parameters for the `ASSET_WITHDRAWAL_DECIMALS` function with signature `ASSET_WITHDRAWAL_DECIMALS()` and selector `0x8f2d8cb8`
    #[derive(
        Clone,
    ...
    #[ethcall(name = "ASSET_WITHDRAWAL_DECIMALS", abi = "ASSET_WITHDRAWAL_DECIMALS()")]
    ...
    ///Container type for all input parameters for the `withdrawToSequencer` function with signature `withdrawToSequencer(uint256,address)` and selector `0x757e9874`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    impl ::ethers::core::abi::AbiDecode for AstriaMintableERC20Calls {
        fn decode(
            ...
            let data = data.as_ref();
            if let Ok(decoded) = <AssetWithdrawalDecimalsCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
    ...
    impl ::core::convert::From<AssetWithdrawalDecimalsCall>
    for AstriaMintableERC20Calls {
    ...
    ///Container type for all return fields from the `ASSET_WITHDRAWAL_DECIMALS` function with signature `ASSET_WITHDRAWAL_DECIMALS()` and selector `0x8f2d8cb8`
    #[derive(
        Clone,
