...
pub mod astria_withdrawer {
    ...
    ///Container type for all input parameters for the `withdrawToOriginChain` function with signature `withdrawToOriginChain(string,string)` and selector `0x91bd1dde`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    impl ::ethers::core::abi::AbiDecode for AstriaWithdrawerCalls {
        fn decode(
            ...
            if let Ok(decoded) = <WithdrawToOriginChainCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
