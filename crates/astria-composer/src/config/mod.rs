...
fn default_api_listen_addr() -> SocketAddr {
    constants::DEFAULT_API_LISTEN_ADDR
}
...
mod tests {
    ...
    fn set_all_env(jail: &mut Jail) {
        ...
        jail.set_env("ASTRIA_COMPOSER_API_LISTEN_ADDR", "127.0.0.1:5050");
        ...
        jail.set_env("ASTRIA_COMPOSER_EXECUTION_WS_URL", "127.0.0.1:40041");
    }
