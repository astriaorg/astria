...
const DEFAULT_ROLLUP_CHART_PATH: &str =
    "https://github.com/astriaorg/charts/releases/download/evm-rollup-0.18.1/evm-rollup-0.18.1.tgz";
const DEFAULT_SEQUENCER_GRPC: &str = "https://grpc.sequencer.dusk-6.devnet.astria.org/";
