...
pub(in crate::auctioneer) struct BlockHeight(u64);
...
impl From<BlockHeight> for crate::storage::StoredValue<'_> {
    fn from(block_height: BlockHeight) -> Self {
        crate::storage::StoredValue::Auctioneer(Value(ValueImpl::BlockHeight(block_height)))
    }
}
...
impl<'a> TryFrom<crate::storage::StoredValue<'a>> for BlockHeight {
    ...
    fn try_from(value: crate::storage::StoredValue<'a>) -> Result<Self, Self::Error> {
        let crate::storage::StoredValue::Auctioneer(Value(ValueImpl::BlockHeight(block_height))) =
            value
        else {
