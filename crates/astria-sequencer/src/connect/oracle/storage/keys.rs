...
pub(in crate::connect::oracle) const CURRENCY_PAIR_TO_ID_PREFIX: &str =
    "connect/oracle/currency_pair_to_id/";
const ID_TO_CURRENCY_PAIR_PREFIX: &str = "connect/oracle/id_to_currency_pair/";
pub(in crate::connect::oracle) const CURRENCY_PAIR_STATE_PREFIX: &str =
...
pub(in crate::connect::oracle) fn currency_pair_to_id(currency_pair: &CurrencyPair) -> String {
    format!(
...
pub(in crate::connect::oracle) fn id_to_currency_pair(id: CurrencyPairId) -> String {
    format!("{ID_TO_CURRENCY_PAIR_PREFIX}{id}")
}

pub(in crate::connect::oracle) fn currency_pair_state(currency_pair: &CurrencyPair) -> String {
...
mod tests {
    ...
    const COMPONENT_PREFIX: &str = "connect/oracle/";
