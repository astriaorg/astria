...
async fn app_execute_transaction_action_index_correctly_increments() {
    ...
    assert_eq!(deposits[0].position_in_source_transaction(), starting_index_of_action);
    assert_eq!(deposits[1].position_in_source_transaction(), starting_index_of_action + 1);
}