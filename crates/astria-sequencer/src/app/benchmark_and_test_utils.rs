...
pub(crate) fn default_fees() -> astria_core::protocol::genesis::v1::GenesisFees {
    astria_core::protocol::genesis::v1::GenesisFees {
        transfer: Some(TransferFeeComponents::new(12, 0)),
        rollup_data_submission: Some(RollupDataSubmissionFeeComponents::new(32, 1)),
        init_bridge_account: Some(InitBridgeAccountFeeComponents::new(48, 0)),
        // should reflect transfer fee
        bridge_lock: Some(BridgeLockFeeComponents::new(12, 1)),
        bridge_sudo_change: Some(BridgeSudoChangeFeeComponents::new(24, 0)),
        ics20_withdrawal: Some(Ics20WithdrawalFeeComponents::new(24, 0)),
        // should reflect transfer fee
        bridge_unlock: Some(BridgeUnlockFeeComponents::new(12, 0)),
        ibc_relay: Some(IbcRelayFeeComponents::new(0, 0)),
        validator_update: Some(ValidatorUpdateFeeComponents::new(0, 0)),
        fee_asset_change: Some(FeeAssetChangeFeeComponents::new(0, 0)),
        fee_change: FeeChangeFeeComponents::new(0, 0),
        ibc_relayer_change: Some(IbcRelayerChangeFeeComponents::new(0, 0)),
        sudo_address_change: Some(SudoAddressChangeFeeComponents::new(0, 0)),
        ibc_sudo_change: Some(IbcSudoChangeFeeComponents::new(0, 0)),
    }
}
...
pub(crate) async fn mock_state_getter() -> StateDelta<Snapshot> {
    ...
    // setup tx fees
    let transfer_fees = TransferFeeComponents::new(0, 0);
    state
