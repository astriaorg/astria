...
pub(in crate::authority) const VALIDATOR_UPDATES: &[u8] = b"authority/validator_updates";
...
mod tests {
    ...
    fn keys_should_not_change() {
        ...
        insta::assert_snapshot!(base64(VALIDATOR_UPDATES));
    }
    ...
    fn keys_should_have_component_prefix() {
        ...
        assert!(VALIDATOR_UPDATES.starts_with(COMPONENT_PREFIX.as_bytes()));
    }
}
