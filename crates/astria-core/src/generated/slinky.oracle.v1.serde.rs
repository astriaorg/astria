...
impl<'de> serde::Deserialize<'de> for CurrencyPairGenesis {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct slinky.oracle.v1.CurrencyPairGenesis")
            }
        ...
        deserializer.deserialize_struct("slinky.oracle.v1.CurrencyPairGenesis", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CurrencyPairState {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("slinky.oracle.v1.CurrencyPairState", len)?;
...
impl<'de> serde::Deserialize<'de> for CurrencyPairState {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct slinky.oracle.v1.CurrencyPairState")
            }
        ...
        deserializer.deserialize_struct("slinky.oracle.v1.CurrencyPairState", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for GenesisState {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct slinky.oracle.v1.GenesisState")
            }
        ...
        deserializer.deserialize_struct("slinky.oracle.v1.GenesisState", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetAllCurrencyPairsRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("slinky.oracle.v1.GetAllCurrencyPairsRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for GetAllCurrencyPairsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct slinky.oracle.v1.GetAllCurrencyPairsRequest")
            }
        ...
        deserializer.deserialize_struct("slinky.oracle.v1.GetAllCurrencyPairsRequest", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for GetAllCurrencyPairsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct slinky.oracle.v1.GetAllCurrencyPairsResponse")
            }
        ...
        deserializer.deserialize_struct("slinky.oracle.v1.GetAllCurrencyPairsResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetCurrencyPairMappingRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("slinky.oracle.v1.GetCurrencyPairMappingRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for GetCurrencyPairMappingRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct slinky.oracle.v1.GetCurrencyPairMappingRequest")
            }
        ...
        deserializer.deserialize_struct("slinky.oracle.v1.GetCurrencyPairMappingRequest", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for GetCurrencyPairMappingResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct slinky.oracle.v1.GetCurrencyPairMappingResponse")
            }
        ...
        deserializer.deserialize_struct("slinky.oracle.v1.GetCurrencyPairMappingResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for GetPriceRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct slinky.oracle.v1.GetPriceRequest")
            }
        ...
        deserializer.deserialize_struct("slinky.oracle.v1.GetPriceRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetPriceResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("slinky.oracle.v1.GetPriceResponse", len)?;
        if let Some(v) = self.price.as_ref() {
            struct_ser.serialize_field("price", v)?;
        }
        if self.nonce != 0 {
...
impl<'de> serde::Deserialize<'de> for GetPriceResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct slinky.oracle.v1.GetPriceResponse")
            }
        ...
        deserializer.deserialize_struct("slinky.oracle.v1.GetPriceResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for GetPricesRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct slinky.oracle.v1.GetPricesRequest")
            }
        ...
        deserializer.deserialize_struct("slinky.oracle.v1.GetPricesRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetPricesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("slinky.oracle.v1.GetPricesResponse", len)?;
        if !self.prices.is_empty() {
...
impl<'de> serde::Deserialize<'de> for GetPricesResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct slinky.oracle.v1.GetPricesResponse")
            }
        ...
        deserializer.deserialize_struct("slinky.oracle.v1.GetPricesResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgAddCurrencyPairs {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("slinky.oracle.v1.MsgAddCurrencyPairs", len)?;
        if !self.authority.is_empty() {
...
impl<'de> serde::Deserialize<'de> for MsgAddCurrencyPairs {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = MsgAddCurrencyPairs;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct slinky.oracle.v1.MsgAddCurrencyPairs")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MsgAddCurrencyPairs, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(MsgAddCurrencyPairs {
                    authority: authority__.unwrap_or_default(),
                    currency_pairs: currency_pairs__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("slinky.oracle.v1.MsgAddCurrencyPairs", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgAddCurrencyPairsResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("slinky.oracle.v1.MsgAddCurrencyPairsResponse", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for MsgAddCurrencyPairsResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = MsgAddCurrencyPairsResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct slinky.oracle.v1.MsgAddCurrencyPairsResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MsgAddCurrencyPairsResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                while map_.next_key::<GeneratedField>()?.is_some() {
                ...
                Ok(MsgAddCurrencyPairsResponse {
                })
            }
        }
        deserializer.deserialize_struct("slinky.oracle.v1.MsgAddCurrencyPairsResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgRemoveCurrencyPairs {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("slinky.oracle.v1.MsgRemoveCurrencyPairs", len)?;
        if !self.authority.is_empty() {
            struct_ser.serialize_field("authority", &self.authority)?;
        }
        if !self.currency_pair_ids.is_empty() {
...
impl<'de> serde::Deserialize<'de> for MsgRemoveCurrencyPairs {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = MsgRemoveCurrencyPairs;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct slinky.oracle.v1.MsgRemoveCurrencyPairs")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MsgRemoveCurrencyPairs, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut authority__ = None;
                ...
                Ok(MsgRemoveCurrencyPairs {
                    authority: authority__.unwrap_or_default(),
                    currency_pair_ids: currency_pair_ids__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("slinky.oracle.v1.MsgRemoveCurrencyPairs", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgRemoveCurrencyPairsResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("slinky.oracle.v1.MsgRemoveCurrencyPairsResponse", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for MsgRemoveCurrencyPairsResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = MsgRemoveCurrencyPairsResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct slinky.oracle.v1.MsgRemoveCurrencyPairsResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MsgRemoveCurrencyPairsResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                while map_.next_key::<GeneratedField>()?.is_some() {
                ...
                Ok(MsgRemoveCurrencyPairsResponse {
                })
            }
        }
        deserializer.deserialize_struct("slinky.oracle.v1.MsgRemoveCurrencyPairsResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QuotePrice {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("slinky.oracle.v1.QuotePrice", len)?;
        if !self.price.is_empty() {
...
impl<'de> serde::Deserialize<'de> for QuotePrice {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct slinky.oracle.v1.QuotePrice")
            }
        ...
        deserializer.deserialize_struct("slinky.oracle.v1.QuotePrice", FIELDS, GeneratedVisitor)
    }
}
