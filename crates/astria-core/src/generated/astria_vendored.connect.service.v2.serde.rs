impl serde::Serialize for QueryMarketMapRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer.serialize_struct("astria_vendored.connect.service.v2.QueryMarketMapRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for QueryMarketMapRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria_vendored.connect.service.v2.QueryMarketMapRequest")
            }
        ...
        deserializer.deserialize_struct("astria_vendored.connect.service.v2.QueryMarketMapRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryMarketMapResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria_vendored.connect.service.v2.QueryMarketMapResponse", len)?;
...
impl<'de> serde::Deserialize<'de> for QueryMarketMapResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria_vendored.connect.service.v2.QueryMarketMapResponse")
            }
        ...
        deserializer.deserialize_struct("astria_vendored.connect.service.v2.QueryMarketMapResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryPricesRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("astria_vendored.connect.service.v2.QueryPricesRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for QueryPricesRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria_vendored.connect.service.v2.QueryPricesRequest")
            }
        ...
        deserializer.deserialize_struct("astria_vendored.connect.service.v2.QueryPricesRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryPricesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria_vendored.connect.service.v2.QueryPricesResponse", len)?;
        if !self.prices.is_empty() {
...
impl<'de> serde::Deserialize<'de> for QueryPricesResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria_vendored.connect.service.v2.QueryPricesResponse")
            }
        ...
        deserializer.deserialize_struct("astria_vendored.connect.service.v2.QueryPricesResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryVersionRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("astria_vendored.connect.service.v2.QueryVersionRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for QueryVersionRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria_vendored.connect.service.v2.QueryVersionRequest")
            }
        ...
        deserializer.deserialize_struct("astria_vendored.connect.service.v2.QueryVersionRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryVersionResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria_vendored.connect.service.v2.QueryVersionResponse", len)?;
        if !self.version.is_empty() {
            struct_ser.serialize_field("version", &self.version)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for QueryVersionResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria_vendored.connect.service.v2.QueryVersionResponse")
            }
        ...
        deserializer.deserialize_struct("astria_vendored.connect.service.v2.QueryVersionResponse", FIELDS, GeneratedVisitor)
    }
}
