impl serde::Serialize for Module {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("slinky.marketmap.module.v1.Module", len)?;
        if !self.authority.is_empty() {
            struct_ser.serialize_field("authority", &self.authority)?;
        }
        if !self.hooks_order.is_empty() {
            struct_ser.serialize_field("hooks_order", &self.hooks_order)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for Module {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct slinky.marketmap.module.v1.Module")
            }
        ...
        deserializer.deserialize_struct("slinky.marketmap.module.v1.Module", FIELDS, GeneratedVisitor)
    }
}
