impl serde::Serialize for AddCurrencyPairsFeeComponents {
    #[allow(deprecated)]
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria.protocol.fees.v1.AddCurrencyPairsFeeComponents", len)?;
...
impl<'de> serde::Deserialize<'de> for AddCurrencyPairsFeeComponents {
    #[allow(deprecated)]
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = AddCurrencyPairsFeeComponents;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.protocol.fees.v1.AddCurrencyPairsFeeComponents")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<AddCurrencyPairsFeeComponents, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(AddCurrencyPairsFeeComponents {
                    base: base__,
                    multiplier: multiplier__,
                })
            }
        }
        deserializer.deserialize_struct("astria.protocol.fees.v1.AddCurrencyPairsFeeComponents", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for RemoveCurrencyPairsFeeComponents {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria.protocol.fees.v1.RemoveCurrencyPairsFeeComponents", len)?;
        if let Some(v) = self.base.as_ref() {
            struct_ser.serialize_field("base", v)?;
        }
        if let Some(v) = self.multiplier.as_ref() {
...
impl<'de> serde::Deserialize<'de> for RemoveCurrencyPairsFeeComponents {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = RemoveCurrencyPairsFeeComponents;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.protocol.fees.v1.RemoveCurrencyPairsFeeComponents")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<RemoveCurrencyPairsFeeComponents, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut base__ = None;
                ...
                Ok(RemoveCurrencyPairsFeeComponents {
                    base: base__,
                    multiplier: multiplier__,
                })
            }
        }
        deserializer.deserialize_struct("astria.protocol.fees.v1.RemoveCurrencyPairsFeeComponents", FIELDS, GeneratedVisitor)
    }
}
