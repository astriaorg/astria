...
impl serde::Serialize for ValidatorUpdateV2FeeComponents {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria.protocol.fees.v1.ValidatorUpdateV2FeeComponents", len)?;
        if let Some(v) = self.base.as_ref() {
            struct_ser.serialize_field("base", v)?;
        }
        if let Some(v) = self.multiplier.as_ref() {
...
impl<'de> serde::Deserialize<'de> for ValidatorUpdateV2FeeComponents {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.protocol.fees.v1.ValidatorUpdateV2FeeComponents")
            }
        ...
        deserializer.deserialize_struct("astria.protocol.fees.v1.ValidatorUpdateV2FeeComponents", FIELDS, GeneratedVisitor)
    }
}
