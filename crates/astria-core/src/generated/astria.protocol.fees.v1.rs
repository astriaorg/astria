...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct AddCurrencyPairsFeeComponents {
    #[prost(message, optional, tag = "1")]
    pub base: ::core::option::Option<super::super::super::primitive::v1::Uint128>,
    #[prost(message, optional, tag = "2")]
    pub multiplier: ::core::option::Option<super::super::super::primitive::v1::Uint128>,
}
impl ::prost::Name for AddCurrencyPairsFeeComponents {
    const NAME: &'static str = "AddCurrencyPairsFeeComponents";
    const PACKAGE: &'static str = "astria.protocol.fees.v1";
    fn full_name() -> ::prost::alloc::string::String {
        ::prost::alloc::format!("astria.protocol.fees.v1.{}", Self::NAME)
    }
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct RemoveCurrencyPairsFeeComponents {
    #[prost(message, optional, tag = "1")]
    pub base: ::core::option::Option<super::super::super::primitive::v1::Uint128>,
    #[prost(message, optional, tag = "2")]
    pub multiplier: ::core::option::Option<super::super::super::primitive::v1::Uint128>,
}
impl ::prost::Name for RemoveCurrencyPairsFeeComponents {
    const NAME: &'static str = "RemoveCurrencyPairsFeeComponents";
    const PACKAGE: &'static str = "astria.protocol.fees.v1";
    fn full_name() -> ::prost::alloc::string::String {
        ::prost::alloc::format!("astria.protocol.fees.v1.{}", Self::NAME)
    }
