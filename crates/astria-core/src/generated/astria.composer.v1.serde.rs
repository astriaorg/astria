impl serde::Serialize for SubmitRollupTransactionRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria.composer.v1.SubmitRollupTransactionRequest", len)?;
...
impl<'de> serde::Deserialize<'de> for SubmitRollupTransactionRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.composer.v1.SubmitRollupTransactionRequest")
            }
        ...
        deserializer.deserialize_struct("astria.composer.v1.SubmitRollupTransactionRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SubmitRollupTransactionResponse {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("astria.composer.v1.SubmitRollupTransactionResponse", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for SubmitRollupTransactionResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.composer.v1.SubmitRollupTransactionResponse")
            }
        ...
        deserializer.deserialize_struct("astria.composer.v1.SubmitRollupTransactionResponse", FIELDS, GeneratedVisitor)
    }
}
