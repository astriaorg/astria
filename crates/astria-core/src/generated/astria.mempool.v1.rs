...
/// A request to get the fees for the given transaction on the Astria Sequencer.
...
impl ::prost::Name for GetTransactionFeesRequest {
    const NAME: &'static str = "GetTransactionFeesRequest";
    const PACKAGE: &'static str = "astria.mempool.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "astria.mempool.v1.GetTransactionFeesRequest".into()
    }
...
impl ::prost::Name for GetTransactionFeesResponse {
    const NAME: &'static str = "GetTransactionFeesResponse";
    const PACKAGE: &'static str = "astria.mempool.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "astria.mempool.v1.GetTransactionFeesResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/astria.mempool.v1.GetTransactionFeesResponse".into()
    }
...
pub mod transaction_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_transaction_fees(
            &mut self,
            request: impl tonic::IntoRequest<super::GetTransactionFeesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetTransactionFeesResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/astria.mempool.v1.TransactionService/GetTransactionFees",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod transaction_service_server {
    ...
    pub trait TransactionService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn get_transaction_fees(
            self: std::sync::Arc<Self>,
            request: tonic::Request<super::GetTransactionFeesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetTransactionFeesResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/astria.mempool.v1.TransactionService/GetTransactionFees" => {
                    #[allow(non_camel_case_types)]
                    struct GetTransactionFeesSvc<T: TransactionService>(pub Arc<T>);
                    impl<
                        T: TransactionService,
                    > tonic::server::UnaryService<super::GetTransactionFeesRequest>
                    for GetTransactionFeesSvc<T> {
                        type Response = super::GetTransactionFeesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TransactionService>::get_transaction_fees(
                                        inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetTransactionFeesSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
