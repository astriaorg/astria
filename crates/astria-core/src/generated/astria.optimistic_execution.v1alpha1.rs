...
impl ::prost::Name for BaseBlock {
    ...
    fn full_name() -> ::prost::alloc::string::String {
        "astria.optimistic_execution.v1alpha1.BaseBlock".into()
    }
...
impl ::prost::Name for ExecuteOptimisticBlockStreamRequest {
    ...
    const PACKAGE: &'static str = "astria.optimistic_execution.v1alpha1";
    fn full_name() -> ::prost::alloc::string::String {
        "astria.optimistic_execution.v1alpha1.ExecuteOptimisticBlockStreamRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/astria.optimistic_execution.v1alpha1.ExecuteOptimisticBlockStreamRequest"
            .into()
    }
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
impl ::prost::Name for ExecuteOptimisticBlockStreamResponse {
    ...
    const PACKAGE: &'static str = "astria.optimistic_execution.v1alpha1";
    fn full_name() -> ::prost::alloc::string::String {
        "astria.optimistic_execution.v1alpha1.ExecuteOptimisticBlockStreamResponse"
            .into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/astria.optimistic_execution.v1alpha1.ExecuteOptimisticBlockStreamResponse"
...
pub mod optimistic_execution_service_server {
    ...
    #[async_trait]
    pub trait OptimisticExecutionService: std::marker::Send + std::marker::Sync + 'static {
    ...
    #[derive(Debug)]
    pub struct OptimisticExecutionServiceServer<T> {
        inner: Arc<T>,
    ...
    impl<T> OptimisticExecutionServiceServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T> Clone for OptimisticExecutionServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "astria.optimistic_execution.v1alpha1.OptimisticExecutionService";
    impl<T> tonic::server::NamedService for OptimisticExecutionServiceServer<T> {
