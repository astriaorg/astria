...
impl serde::Serialize for GetBlockCommitmentStreamRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("astria.sequencerblock.v1.GetBlockCommitmentStreamRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for GetBlockCommitmentStreamRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.sequencerblock.v1.GetBlockCommitmentStreamRequest")
            }
        ...
        deserializer.deserialize_struct("astria.sequencerblock.v1.GetBlockCommitmentStreamRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetBlockCommitmentStreamResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria.sequencerblock.v1.GetBlockCommitmentStreamResponse", len)?;
...
impl<'de> serde::Deserialize<'de> for GetBlockCommitmentStreamResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.sequencerblock.v1.GetBlockCommitmentStreamResponse")
            }
        ...
        deserializer.deserialize_struct("astria.sequencerblock.v1.GetBlockCommitmentStreamResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for GetOptimisticBlockStreamRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria.sequencerblock.v1.GetOptimisticBlockStreamRequest", len)?;
        if let Some(v) = self.rollup_id.as_ref() {
            struct_ser.serialize_field("rollupId", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for GetOptimisticBlockStreamRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.sequencerblock.v1.GetOptimisticBlockStreamRequest")
            }
        ...
        deserializer.deserialize_struct("astria.sequencerblock.v1.GetOptimisticBlockStreamRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetOptimisticBlockStreamResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria.sequencerblock.v1.GetOptimisticBlockStreamResponse", len)?;
...
impl<'de> serde::Deserialize<'de> for GetOptimisticBlockStreamResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.sequencerblock.v1.GetOptimisticBlockStreamResponse")
            }
        ...
        deserializer.deserialize_struct("astria.sequencerblock.v1.GetOptimisticBlockStreamResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for SequencerBlockCommit {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria.sequencerblock.v1.SequencerBlockCommit", len)?;
        if self.height != 0 {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("height", ToString::to_string(&self.height).as_str())?;
        }
...
impl<'de> serde::Deserialize<'de> for SequencerBlockCommit {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.sequencerblock.v1.SequencerBlockCommit")
            }
        ...
        deserializer.deserialize_struct("astria.sequencerblock.v1.SequencerBlockCommit", FIELDS, GeneratedVisitor)
    }
}
