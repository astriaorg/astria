impl serde::Serialize for OracleVoteExtension {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("price_feed.abci.v2.OracleVoteExtension", len)?;
        if !self.prices.is_empty() {
...
impl<'de> serde::Deserialize<'de> for OracleVoteExtension {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct price_feed.abci.v2.OracleVoteExtension")
            }
        ...
        deserializer.deserialize_struct("price_feed.abci.v2.OracleVoteExtension", FIELDS, GeneratedVisitor)
    }
}
