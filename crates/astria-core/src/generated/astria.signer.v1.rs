...
impl ::prost::Name for CommitmentWithIdentifier {
    ...
    fn full_name() -> ::prost::alloc::string::String {
        "astria.signer.v1.CommitmentWithIdentifier".into()
    }
...
impl ::prost::Name for GetVerifyingShareRequest {
    ...
    const PACKAGE: &'static str = "astria.signer.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "astria.signer.v1.GetVerifyingShareRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/astria.signer.v1.GetVerifyingShareRequest".into()
    }
...
impl ::prost::Name for ExecuteRoundOneRequest {
    ...
    const PACKAGE: &'static str = "astria.signer.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "astria.signer.v1.ExecuteRoundOneRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/astria.signer.v1.ExecuteRoundOneRequest".into()
    }
...
impl ::prost::Name for RoundOneResponse {
    ...
    const PACKAGE: &'static str = "astria.signer.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "astria.signer.v1.RoundOneResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/astria.signer.v1.RoundOneResponse".into()
    }
...
impl ::prost::Name for ExecuteRoundTwoRequest {
    ...
    const PACKAGE: &'static str = "astria.signer.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "astria.signer.v1.ExecuteRoundTwoRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/astria.signer.v1.ExecuteRoundTwoRequest".into()
    }
...
impl ::prost::Name for RoundTwoResponse {
    ...
    const PACKAGE: &'static str = "astria.signer.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "astria.signer.v1.RoundTwoResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/astria.signer.v1.RoundTwoResponse".into()
    }
...
impl ::prost::Name for VerifyingShare {
    ...
    const PACKAGE: &'static str = "astria.signer.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "astria.signer.v1.VerifyingShare".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/astria.signer.v1.VerifyingShare".into()
    }
...
pub mod frost_participant_service_server {
    ...
    #[async_trait]
    pub trait FrostParticipantService: std::marker::Send + std::marker::Sync + 'static {
    ...
    #[derive(Debug)]
    pub struct FrostParticipantServiceServer<T> {
        inner: Arc<T>,
    ...
    impl<T> FrostParticipantServiceServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T> Clone for FrostParticipantServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "astria.signer.v1.FrostParticipantService";
    impl<T> tonic::server::NamedService for FrostParticipantServiceServer<T> {
