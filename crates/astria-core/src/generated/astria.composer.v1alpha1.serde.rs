...
impl serde::Serialize for ToBBundleRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria.composer.v1alpha1.ToBBundleRequest", len)?;
        if self.height != 0 {
            #[allow(clippy::needless_borrow)]
...
impl<'de> serde::Deserialize<'de> for ToBBundleRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ToBBundleRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.composer.v1alpha1.ToBBundleRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ToBBundleRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("astria.composer.v1alpha1.ToBBundleRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ToBBundleResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria.composer.v1alpha1.ToBBundleResponse", len)?;
        if let Some(v) = self.bundle.as_ref() {
            struct_ser.serialize_field("bundle", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for ToBBundleResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ToBBundleResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.composer.v1alpha1.ToBBundleResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ToBBundleResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut bundle__ = None;
                ...
                Ok(ToBBundleResponse {
                    bundle: bundle__,
                })
            }
        }
        deserializer.deserialize_struct("astria.composer.v1alpha1.ToBBundleResponse", FIELDS, GeneratedVisitor)
    }
}
