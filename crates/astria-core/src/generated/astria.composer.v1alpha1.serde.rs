...
impl serde::Serialize for SendFinalizedHashRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria.composer.v1alpha1.SendFinalizedHashRequest", len)?;
        if !self.block_hash.is_empty() {
            #[allow(clippy::needless_borrow)]
...
impl<'de> serde::Deserialize<'de> for SendFinalizedHashRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = SendFinalizedHashRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.composer.v1alpha1.SendFinalizedHashRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<SendFinalizedHashRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(SendFinalizedHashRequest {
                    block_hash: block_hash__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("astria.composer.v1alpha1.SendFinalizedHashRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SendFinalizedHashResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("astria.composer.v1alpha1.SendFinalizedHashResponse", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for SendFinalizedHashResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = SendFinalizedHashResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.composer.v1alpha1.SendFinalizedHashResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<SendFinalizedHashResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
...
impl serde::Serialize for SendOptimisticBlockResponse {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("astria.composer.v1alpha1.SendOptimisticBlockResponse", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for SendOptimisticBlockResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = SendOptimisticBlockResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.composer.v1alpha1.SendOptimisticBlockResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<SendOptimisticBlockResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                while map_.next_key::<GeneratedField>()?.is_some() {
                ...
                Ok(SendOptimisticBlockResponse {
                })
            }
        }
        deserializer.deserialize_struct("astria.composer.v1alpha1.SendOptimisticBlockResponse", FIELDS, GeneratedVisitor)
    }
}
