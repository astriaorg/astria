impl serde::Serialize for Ics20TransferDeposit {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria.protocol.memos.v1.Ics20TransferDeposit", len)?;
        if !self.rollup_deposit_address.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Ics20TransferDeposit {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.protocol.memos.v1.Ics20TransferDeposit")
            }
        ...
        deserializer.deserialize_struct("astria.protocol.memos.v1.Ics20TransferDeposit", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for Ics20WithdrawalFromRollup {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.protocol.memos.v1.Ics20WithdrawalFromRollup")
            }
        ...
        deserializer.deserialize_struct("astria.protocol.memos.v1.Ics20WithdrawalFromRollup", FIELDS, GeneratedVisitor)
    }
}
