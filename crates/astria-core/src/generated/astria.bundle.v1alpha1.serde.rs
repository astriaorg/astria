impl serde::Serialize for AuctionResult {
    #[allow(deprecated)]
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria.bundle.v1alpha1.AuctionResult", len)?;
        if !self.signature.is_empty() {
...
impl<'de> serde::Deserialize<'de> for AuctionResult {
    #[allow(deprecated)]
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = AuctionResult;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.bundle.v1alpha1.AuctionResult")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<AuctionResult, V::Error>
                where
        ...
        deserializer.deserialize_struct("astria.bundle.v1alpha1.AuctionResult", FIELDS, GeneratedVisitor)
    }
}
