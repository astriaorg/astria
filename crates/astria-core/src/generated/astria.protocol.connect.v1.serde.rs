impl serde::Serialize for ExtendedCommitInfoWithCurrencyPairMapping {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria.protocol.connect.v1.ExtendedCommitInfoWithCurrencyPairMapping", len)?;
...
impl<'de> serde::Deserialize<'de> for ExtendedCommitInfoWithCurrencyPairMapping {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.protocol.connect.v1.ExtendedCommitInfoWithCurrencyPairMapping")
            }
        ...
        deserializer.deserialize_struct("astria.protocol.connect.v1.ExtendedCommitInfoWithCurrencyPairMapping", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for IdWithCurrencyPair {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.protocol.connect.v1.IdWithCurrencyPair")
            }
        ...
        deserializer.deserialize_struct("astria.protocol.connect.v1.IdWithCurrencyPair", FIELDS, GeneratedVisitor)
    }
}
