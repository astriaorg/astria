impl serde::Serialize for CurrencyPair {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("slinky.types.v1.CurrencyPair", len)?;
        if !self.base.is_empty() {
...
impl<'de> serde::Deserialize<'de> for CurrencyPair {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct slinky.types.v1.CurrencyPair")
            }
        ...
        deserializer.deserialize_struct("slinky.types.v1.CurrencyPair", FIELDS, GeneratedVisitor)
    }
}
