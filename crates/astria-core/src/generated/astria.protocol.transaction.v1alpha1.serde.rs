        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.fee_components.as_ref() {
            match v {
                ...
                fee_change::FeeComponents::ValidatorUpdateV2(v) => {
                    struct_ser.serialize_field("validatorUpdateV2", v)?;
                }
            }
        }
...
;
                        ...
                        GeneratedField::ValidatorUpdateV2 => {
                            ...
                            fee_components__ = map_.next_value::<::std::option::Option<_>>()?.map(fee_change::FeeComponents::ValidatorUpdateV2)
;
                        }
                    }
                }
...
impl serde::Serialize for ValidatorUpdateV2 {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria.protocol.transaction.v1alpha1.ValidatorUpdateV2", len)?;
...
impl<'de> serde::Deserialize<'de> for ValidatorUpdateV2 {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ValidatorUpdateV2;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.protocol.transaction.v1alpha1.ValidatorUpdateV2")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ValidatorUpdateV2, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("astria.protocol.transaction.v1alpha1.ValidatorUpdateV2", FIELDS, GeneratedVisitor)
    }
}
