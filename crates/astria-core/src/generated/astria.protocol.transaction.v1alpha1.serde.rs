...
impl serde::Serialize for Body {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria.protocol.transaction.v1alpha1.Body", len)?;
        if !self.actions.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Body {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.protocol.transaction.v1alpha1.Body")
            }
        ...
        deserializer.deserialize_struct("astria.protocol.transaction.v1alpha1.Body", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for Params {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria.protocol.transaction.v1alpha1.Params", len)?;
        if self.nonce != 0 {
...
impl<'de> serde::Deserialize<'de> for Params {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.protocol.transaction.v1alpha1.Params")
            }
        ...
        deserializer.deserialize_struct("astria.protocol.transaction.v1alpha1.Params", FIELDS, GeneratedVisitor)
    }
}
