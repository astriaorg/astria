impl serde::Serialize for OracleVoteExtension {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria_vendored.slinky.abci.v1.OracleVoteExtension", len)?;
        if !self.prices.is_empty() {
...
impl<'de> serde::Deserialize<'de> for OracleVoteExtension {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria_vendored.slinky.abci.v1.OracleVoteExtension")
            }
        ...
        deserializer.deserialize_struct("astria_vendored.slinky.abci.v1.OracleVoteExtension", FIELDS, GeneratedVisitor)
    }
}
