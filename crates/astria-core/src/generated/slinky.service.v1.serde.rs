impl serde::Serialize for QueryMarketMapRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer.serialize_struct("slinky.service.v1.QueryMarketMapRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for QueryMarketMapRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct slinky.service.v1.QueryMarketMapRequest")
            }
        ...
        deserializer.deserialize_struct("slinky.service.v1.QueryMarketMapRequest", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for QueryMarketMapResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct slinky.service.v1.QueryMarketMapResponse")
            }
        ...
        deserializer.deserialize_struct("slinky.service.v1.QueryMarketMapResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryPricesRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("slinky.service.v1.QueryPricesRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for QueryPricesRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct slinky.service.v1.QueryPricesRequest")
            }
        ...
        deserializer.deserialize_struct("slinky.service.v1.QueryPricesRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryPricesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("slinky.service.v1.QueryPricesResponse", len)?;
        if !self.prices.is_empty() {
...
impl<'de> serde::Deserialize<'de> for QueryPricesResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct slinky.service.v1.QueryPricesResponse")
            }
        ...
        deserializer.deserialize_struct("slinky.service.v1.QueryPricesResponse", FIELDS, GeneratedVisitor)
    }
}
