impl serde::Serialize for CurrencyPairGenesis {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria_vendored.slinky.oracle.v1.CurrencyPairGenesis", len)?;
...
impl<'de> serde::Deserialize<'de> for CurrencyPairGenesis {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria_vendored.slinky.oracle.v1.CurrencyPairGenesis")
            }
        ...
        deserializer.deserialize_struct("astria_vendored.slinky.oracle.v1.CurrencyPairGenesis", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CurrencyPairState {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria_vendored.slinky.oracle.v1.CurrencyPairState", len)?;
...
impl<'de> serde::Deserialize<'de> for CurrencyPairState {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria_vendored.slinky.oracle.v1.CurrencyPairState")
            }
        ...
        deserializer.deserialize_struct("astria_vendored.slinky.oracle.v1.CurrencyPairState", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GenesisState {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria_vendored.slinky.oracle.v1.GenesisState", len)?;
        if !self.currency_pair_genesis.is_empty() {
...
impl<'de> serde::Deserialize<'de> for GenesisState {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria_vendored.slinky.oracle.v1.GenesisState")
            }
        ...
        deserializer.deserialize_struct("astria_vendored.slinky.oracle.v1.GenesisState", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetAllCurrencyPairsRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("astria_vendored.slinky.oracle.v1.GetAllCurrencyPairsRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for GetAllCurrencyPairsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria_vendored.slinky.oracle.v1.GetAllCurrencyPairsRequest")
            }
        ...
        deserializer.deserialize_struct("astria_vendored.slinky.oracle.v1.GetAllCurrencyPairsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetAllCurrencyPairsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria_vendored.slinky.oracle.v1.GetAllCurrencyPairsResponse", len)?;
        if !self.currency_pairs.is_empty() {
...
impl<'de> serde::Deserialize<'de> for GetAllCurrencyPairsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria_vendored.slinky.oracle.v1.GetAllCurrencyPairsResponse")
            }
        ...
        deserializer.deserialize_struct("astria_vendored.slinky.oracle.v1.GetAllCurrencyPairsResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetCurrencyPairMappingRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("astria_vendored.slinky.oracle.v1.GetCurrencyPairMappingRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for GetCurrencyPairMappingRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria_vendored.slinky.oracle.v1.GetCurrencyPairMappingRequest")
            }
        ...
        deserializer.deserialize_struct("astria_vendored.slinky.oracle.v1.GetCurrencyPairMappingRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetCurrencyPairMappingResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria_vendored.slinky.oracle.v1.GetCurrencyPairMappingResponse", len)?;
        if !self.currency_pair_mapping.is_empty() {
...
impl<'de> serde::Deserialize<'de> for GetCurrencyPairMappingResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria_vendored.slinky.oracle.v1.GetCurrencyPairMappingResponse")
            }
        ...
        deserializer.deserialize_struct("astria_vendored.slinky.oracle.v1.GetCurrencyPairMappingResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetPriceRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria_vendored.slinky.oracle.v1.GetPriceRequest", len)?;
        if let Some(v) = self.currency_pair.as_ref() {
            struct_ser.serialize_field("currencyPair", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for GetPriceRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria_vendored.slinky.oracle.v1.GetPriceRequest")
            }
        ...
        deserializer.deserialize_struct("astria_vendored.slinky.oracle.v1.GetPriceRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetPriceResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria_vendored.slinky.oracle.v1.GetPriceResponse", len)?;
        if let Some(v) = self.price.as_ref() {
            struct_ser.serialize_field("price", v)?;
        }
        if self.nonce != 0 {
...
impl<'de> serde::Deserialize<'de> for GetPriceResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria_vendored.slinky.oracle.v1.GetPriceResponse")
            }
        ...
        deserializer.deserialize_struct("astria_vendored.slinky.oracle.v1.GetPriceResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetPricesRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria_vendored.slinky.oracle.v1.GetPricesRequest", len)?;
        if !self.currency_pair_ids.is_empty() {
...
impl<'de> serde::Deserialize<'de> for GetPricesRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria_vendored.slinky.oracle.v1.GetPricesRequest")
            }
        ...
        deserializer.deserialize_struct("astria_vendored.slinky.oracle.v1.GetPricesRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetPricesResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria_vendored.slinky.oracle.v1.GetPricesResponse", len)?;
        if !self.prices.is_empty() {
...
impl<'de> serde::Deserialize<'de> for GetPricesResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria_vendored.slinky.oracle.v1.GetPricesResponse")
            }
        ...
        deserializer.deserialize_struct("astria_vendored.slinky.oracle.v1.GetPricesResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QuotePrice {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria_vendored.slinky.oracle.v1.QuotePrice", len)?;
        if !self.price.is_empty() {
...
impl<'de> serde::Deserialize<'de> for QuotePrice {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria_vendored.slinky.oracle.v1.QuotePrice")
            }
        ...
        deserializer.deserialize_struct("astria_vendored.slinky.oracle.v1.QuotePrice", FIELDS, GeneratedVisitor)
    }
}
