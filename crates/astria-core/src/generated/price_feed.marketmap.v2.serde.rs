impl serde::Serialize for GenesisState {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("price_feed.marketmap.v2.GenesisState", len)?;
...
impl<'de> serde::Deserialize<'de> for GenesisState {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct price_feed.marketmap.v2.GenesisState")
            }
        ...
        deserializer.deserialize_struct("price_feed.marketmap.v2.GenesisState", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for LastUpdatedRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("price_feed.marketmap.v2.LastUpdatedRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for LastUpdatedRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("price_feed.marketmap.v2.LastUpdatedRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for LastUpdatedResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("price_feed.marketmap.v2.LastUpdatedResponse", len)?;
        if self.last_updated != 0 {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("lastUpdated", ToString::to_string(&self.last_updated).as_str())?;
        }
...
impl<'de> serde::Deserialize<'de> for LastUpdatedResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct price_feed.marketmap.v2.LastUpdatedResponse")
            }
        ...
        deserializer.deserialize_struct("price_feed.marketmap.v2.LastUpdatedResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Market {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("price_feed.marketmap.v2.Market", len)?;
...
impl<'de> serde::Deserialize<'de> for Market {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct price_feed.marketmap.v2.Market")
            }
        ...
        deserializer.deserialize_struct("price_feed.marketmap.v2.Market", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MarketMap {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("price_feed.marketmap.v2.MarketMap", len)?;
        if !self.markets.is_empty() {
...
impl<'de> serde::Deserialize<'de> for MarketMap {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct price_feed.marketmap.v2.MarketMap")
            }
        ...
        deserializer.deserialize_struct("price_feed.marketmap.v2.MarketMap", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MarketMapRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("price_feed.marketmap.v2.MarketMapRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for MarketMapRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct price_feed.marketmap.v2.MarketMapRequest")
            }
        ...
        deserializer.deserialize_struct("price_feed.marketmap.v2.MarketMapRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MarketMapResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("price_feed.marketmap.v2.MarketMapResponse", len)?;
        if let Some(v) = self.market_map.as_ref() {
            struct_ser.serialize_field("marketMap", v)?;
        }
        if self.last_updated != 0 {
...
impl<'de> serde::Deserialize<'de> for MarketMapResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("price_feed.marketmap.v2.MarketMapResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MarketRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("price_feed.marketmap.v2.MarketRequest", len)?;
...
impl<'de> serde::Deserialize<'de> for MarketRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("price_feed.marketmap.v2.MarketRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MarketResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("price_feed.marketmap.v2.MarketResponse", len)?;
...
impl<'de> serde::Deserialize<'de> for MarketResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct price_feed.marketmap.v2.MarketResponse")
            }
        ...
        deserializer.deserialize_struct("price_feed.marketmap.v2.MarketResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Params {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("price_feed.marketmap.v2.Params", len)?;
        if !self.market_authorities.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Params {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct price_feed.marketmap.v2.Params")
            }
        ...
        deserializer.deserialize_struct("price_feed.marketmap.v2.Params", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ParamsRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("price_feed.marketmap.v2.ParamsRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for ParamsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct price_feed.marketmap.v2.ParamsRequest")
            }
        ...
        deserializer.deserialize_struct("price_feed.marketmap.v2.ParamsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ParamsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("price_feed.marketmap.v2.ParamsResponse", len)?;
        if let Some(v) = self.params.as_ref() {
            struct_ser.serialize_field("params", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for ParamsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct price_feed.marketmap.v2.ParamsResponse")
            }
        ...
        deserializer.deserialize_struct("price_feed.marketmap.v2.ParamsResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ProviderConfig {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("price_feed.marketmap.v2.ProviderConfig", len)?;
        if !self.name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ProviderConfig {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct price_feed.marketmap.v2.ProviderConfig")
            }
        ...
        deserializer.deserialize_struct("price_feed.marketmap.v2.ProviderConfig", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Ticker {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("price_feed.marketmap.v2.Ticker", len)?;
        if let Some(v) = self.currency_pair.as_ref() {
            struct_ser.serialize_field("currencyPair", v)?;
        }
        if self.decimals != 0 {
...
impl<'de> serde::Deserialize<'de> for Ticker {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct price_feed.marketmap.v2.Ticker")
            }
        ...
        deserializer.deserialize_struct("price_feed.marketmap.v2.Ticker", FIELDS, GeneratedVisitor)
    }
}
