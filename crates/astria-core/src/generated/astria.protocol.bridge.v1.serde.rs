...
impl<'de> serde::Deserialize<'de> for BridgeAccountInfoResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.protocol.bridge.v1.BridgeAccountInfoResponse")
            }
        ...
        deserializer.deserialize_struct("astria.protocol.bridge.v1.BridgeAccountInfoResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for BridgeAccountLastTxHashResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.protocol.bridge.v1.BridgeAccountLastTxHashResponse")
            }
        ...
        deserializer.deserialize_struct("astria.protocol.bridge.v1.BridgeAccountLastTxHashResponse", FIELDS, GeneratedVisitor)
    }
}
