impl serde::Serialize for CelestiaHeader {
    #[allow(deprecated)]
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria.sequencerblock.v1alpha1.CelestiaHeader", len)?;
        if !self.block_hash.is_empty() {
...
impl<'de> serde::Deserialize<'de> for CelestiaHeader {
    #[allow(deprecated)]
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = CelestiaHeader;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.sequencerblock.v1alpha1.CelestiaHeader")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<CelestiaHeader, V::Error>
                where
        ...
        deserializer.deserialize_struct("astria.sequencerblock.v1alpha1.CelestiaHeader", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CelestiaHeaderList {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria.sequencerblock.v1alpha1.CelestiaHeaderList", len)?;
        if !self.headers.is_empty() {
...
impl<'de> serde::Deserialize<'de> for CelestiaHeaderList {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = CelestiaHeaderList;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.sequencerblock.v1alpha1.CelestiaHeaderList")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<CelestiaHeaderList, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(CelestiaHeaderList {
                    headers: headers__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("astria.sequencerblock.v1alpha1.CelestiaHeaderList", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CelestiaRollupData {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria.sequencerblock.v1alpha1.CelestiaRollupData", len)?;
        if !self.sequencer_block_hash.is_empty() {
            #[allow(clippy::needless_borrow)]
...
impl<'de> serde::Deserialize<'de> for CelestiaRollupData {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = CelestiaRollupData;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.sequencerblock.v1alpha1.CelestiaRollupData")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<CelestiaRollupData, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("astria.sequencerblock.v1alpha1.CelestiaRollupData", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CelestiaRollupDataList {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("astria.sequencerblock.v1alpha1.CelestiaRollupDataList", len)?;
        if !self.entries.is_empty() {
...
impl<'de> serde::Deserialize<'de> for CelestiaRollupDataList {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = CelestiaRollupDataList;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct astria.sequencerblock.v1alpha1.CelestiaRollupDataList")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<CelestiaRollupDataList, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(CelestiaRollupDataList {
                    entries: entries__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("astria.sequencerblock.v1alpha1.CelestiaRollupDataList", FIELDS, GeneratedVisitor)
    }
}
