...
impl Bundle {
    ...
    pub(crate) fn into_raw_txs(self) -> Vec<alloy_primitives::Bytes> {
        self.raw_txs
    }
...
/// Converts [`alloy_primitives::Bytes`] to [`bytes::Bytes`].
pub(crate) fn alloy_to_bytes_bytes(in_: alloy_primitives::Bytes) -> bytes::Bytes {
    in_.0
}
