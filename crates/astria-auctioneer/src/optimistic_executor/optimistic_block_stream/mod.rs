...
pub(crate) struct OptimisticBlockStream {
    ...
    client: Pin<Box<dyn Stream<Item = Result<GetOptimisticBlockStreamResponse, tonic::Status>>>>,
}

impl OptimisticBlockStream {
    pub(crate) fn new(client: tonic::Streaming<GetOptimisticBlockStreamResponse>) -> Self {
        Self {
            // client,
