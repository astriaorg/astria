...
pub(super) struct VerifiedBlobs {
    celestia_height: u64,
    header_blobs: HashMap<BlockHash, SubmittedMetadata>,
...
impl VerifiedBlobs {
    ...
    pub(super) fn into_parts(
        ...
        u64,
        HashMap<BlockHash, SubmittedMetadata>,
...
fn ensure_block_hashes_match(in_commit: &[u8], in_header: &BlockHash) -> eyre::Result<()> {
    use base64::prelude::*;
