...
fn is_blob_not_found(error: &jsonrpsee::core::ClientError) -> bool {
...
fn is_null_blobs(error: &jsonrpsee::core::ClientError) -> bool {
    let jsonrpsee::core::ClientError::ParseError(error) = error else {
        return false;
    };
