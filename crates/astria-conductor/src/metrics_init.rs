...
declare_metric_const!(pub const BLOBS_PER_CELESTIA_FETCH);
declare_metric_const!(pub const CELESTIA_BLOB_FETCH_ERROR_COUNT);
declare_metric_const!(pub const DECODED_ITEMS_PER_CELESTIA_FETCH);
declare_metric_const!(pub const SEQUENCER_BLOCKS_METADATA_VERIFIED_PER_CELESTIA_FETCH);
declare_metric_const!(pub const SEQUENCER_BLOCK_INFORMATION_RECONSTRUCTED_PER_CELESTIA_FETCH);

declare_metric_const!(pub const EXECUTED_FIRM_BLOCK_NUMBER);
declare_metric_const!(pub const EXECUTED_SOFT_BLOCK_NUMBER);
declare_metric_const!(pub const TRANSACTIONS_PER_EXECUTED_BLOCK);
