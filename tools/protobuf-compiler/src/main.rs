...
fn main() {
    ...
    tonic_build::configure()
        ...
        .extern_path(".vendored.tendermint.abci", "::tendermint-proto::abci")
        .extern_path(".vendored.tendermint.crypto", "::tendermint-proto::crypto")
        .extern_path(".vendored.tendermint.version", "::tendermint-proto::version")
        .extern_path(".vendored.tendermint.types", "::tendermint-proto::types")
        .extern_path(".vendored.penumbra", "::penumbra-proto")
