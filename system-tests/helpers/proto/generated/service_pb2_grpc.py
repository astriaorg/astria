...
class SequencerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.GetSequencerBlock = channel.unary_unary(
                '/astria.sequencerblock.v1.SequencerService/GetSequencerBlock',
                request_serializer=helpers_dot_proto_dot_generated_dot_service__pb2.GetSequencerBlockRequest.SerializeToString,
                response_deserializer=helpers_dot_proto_dot_generated_dot_service__pb2.SequencerBlock.FromString,
...
class SequencerServiceServicer(object):
    ...
    def GetSequencerBlock(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_SequencerServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetSequencerBlock': grpc.unary_unary_rpc_method_handler(
                    servicer.GetSequencerBlock,
                    request_deserializer=helpers_dot_proto_dot_generated_dot_service__pb2.GetSequencerBlockRequest.FromString,
                    response_serializer=helpers_dot_proto_dot_generated_dot_service__pb2.SequencerBlock.SerializeToString,
            ),
...
class SequencerService(object):
    ...
    def GetSequencerBlock(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/astria.sequencerblock.v1.SequencerService/GetSequencerBlock',
            helpers_dot_proto_dot_generated_dot_service__pb2.GetSequencerBlockRequest.SerializeToString,
            helpers_dot_proto_dot_generated_dot_service__pb2.SequencerBlock.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
